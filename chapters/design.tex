...
As shown in Figure~\ref{fig:launcherLoader}, the relationship between these components exhibits a bidirectional binding:
\begin{itemize}
...
The relationship between the components, as shown in Figure~\ref{fig:scoped-contexts}, is the following:
...
\begin{itemize}
    ...
    \item The \textbf{Terminators Context}, \textit{Output Monitors Context}, and \textit{Global Programs Context} allow the addition of respective components.
    \begin{itemize}
        \item Available elements: -;
        \item Available operations: \textit{add} 
    \end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/lazyeval.pdf}
